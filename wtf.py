...
for sub in subject_list:
    ...
    for i in range(permutation_count):
        ...
        cv = CrossValidation(clf, ChainNode([splt, permutator], space=splt.get_space()), postproc=mean_sample(), errorfx=mean_match_accuracy)
        print(ds.sa.targets)
        print(ds.sa.chunks)
        ...
        acc_nifti = map2nifti(sl_map, imghdr = hdr)
        # write accuracies to file
        acc_nifti.to_filename('/data/clusterfs/pol/bird_fmri/Bird1/Permutations_trainingset_words/up_vs_down_words_3rad_10f_6balancedout_' + subject + 'permutation_' + str(i) + '.nii')